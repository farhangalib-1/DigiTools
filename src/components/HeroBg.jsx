...
const HeroBg = () => {
  ...
  <div class="status status-primary"></div>
             ...
             <h1 className="text-4xl  md:text-[72px] md:leading-20.5 font-bold">Supercharge Your <br /> Digital Workflow</h1>
             <p className=" text-[13px] md:text-[18px] md:leading-7 text-gray-400">Access premium AI tools, design assets, templates, and productivity <br /> software—all in one place. Start creating faster today. <br /> Explore Products</p>
